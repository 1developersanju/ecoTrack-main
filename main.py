...
def userdetails():
    if 'phone_no' in session:
        ...
        return json.dumps({"Applainces":[{"name":"Lights","count":appl.Lights},{"name":"Fans","count":appl.Fans},{"name":"Heater","count":appl.Heater},{"name":"Iron_box","count":appl.Iron_box},{"name":"Television","count":appl.Television},{"name":"Washing_machine","count":appl.Washing_machine},{"name":"Ac","count":appl.Air_conditioner},{"name":"Microwave","count":appl.Microwave},{"name":"Refrigerator","count":appl.Refrigerator}],"details":{"phone_no":user.phone_no,"fullname":user.username,"address":user.address,"electricity_consumer_no":user.electricity_consumer_no,"water_consumer_no":user.water_consumer_no,"lat":user.lat,"lng":user.lng,"electricity_board":user.electricity_board,"water_board":user.water_board,"Number_of_people":user.Number_of_people}}), 200, {'ContentType':'application/json'}
    else:
        return json.dumps({'success':False}), 401, {'ContentType':'application/json'}
